...
class TestEmbeddingPipeline:
    ...
    @pytest.mark.asyncio
    async def test_run_embedding_pipeline_success(self, mock_supabase_client, mock_github_files, mock_chunks, mock_embeddings):
        ...
        # Mock GitHub service
        with patch("app.services.embedding_pipeline.fetch_repository_files", new_callable=AsyncMock) as mock_fetch:
            ...
            with patch("app.services.embedding_pipeline.chunk_files") as mock_chunk:
                ...
                with patch("app.services.embedding_pipeline.store_chunks") as mock_store:
                    ...
                    with patch("app.services.embedding_pipeline.get_embedding_service") as mock_get_embedding_service:
                        ...
                        with patch("app.services.embedding_pipeline.get_qdrant_service") as mock_get_qdrant_service:
